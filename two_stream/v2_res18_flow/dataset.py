...
class VideoDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        flow_buf = self.load_frames(self.video2path[video])
        return torch.from_numpy(flow_buf), torch.from_numpy(label)
...
if __name__ == "__main__":
    ...
    val_data = VideoDataset(
        ...
        split_data='/home/datasets/mayilong/PycharmProjects/p55/two_stream/v1/data/split_data',
        split='val')
    ...
    for idx, (flow_buf, label) in enumerate(val_loader):
        print('flow_buf size is ', flow_buf.size())
        print('label is : ', label)
